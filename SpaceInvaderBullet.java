...
import java.awt.*;
public class SpaceInvaderBullet extends GraphicsObject{
    private int width;
    private int height;
    ImageIcon icon = new ImageIcon("EnemyBulletResize.png");
    Image iconimage = icon.getImage();
    public SpaceInvaderBullet(int x, int y, int width, int height) {
        super(x, y);
        this.width = width;
        this.height = height;
    }
